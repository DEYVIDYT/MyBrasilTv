...
public class DataManager {
    ...
    public Map<String, String> getLiveCategoriesMap() {
        Map<String, String> categoryMap = new HashMap<>();
        if (liveCategories != null) {
            for (XtreamApiService.CategoryInfo category : liveCategories) {
    ...
    public List<Channel> getLiveStreamsByCategory(String categoryId) {
        if (liveStreams == null || categoryId == null) {
