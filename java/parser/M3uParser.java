    ...
    public static List<Channel> parse(BufferedReader reader) throws IOException {
        ...
        while ((line = reader.readLine()) != null) {
            if (line.startsWith(EXTINF_TAG)) {
                ...
                // Usando channelName como streamId temporariamente, pois não há um streamId explícito no M3U
                channels.add(new Channel(channelName, channelUrl, channelLogo, groupTitle, channelName));
                channelName = null;
            }
        }
        return channels;
