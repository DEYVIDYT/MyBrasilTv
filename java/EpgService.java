...
public class EpgService {
    ...
    /**
     * Busca EPG XML completo para todos os canais
     * @param callback Callback para resultado
     */
    public void fetchXmlEpg(EpgCallback callback) {
        executor.execute(() -> {
            ...
            try {
                String apiUrl = String.format("%s/xmltv.php?username=%s&password=%s", 
                    baseUrl, username, password);
                
                Log.d(EPG_TAG, "XML EPG API URL: " + apiUrl.replace(password, "******"));
